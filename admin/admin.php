  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="home_all.php"><i class="fa fa-th"></i> <span>Barang</span>
        ...
        <li class="active"><a href="#"><i class="fa fa-user"></i> <span>Admin</span></a></li>
      </ul>
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
                ...
                <div class="col-md-9 col-sm-8">
                  <div class="pad">
                    ...
                    <?php  
                        ...
                        $query2 = "select * from admin LIMIT $mulai, $halaman";
                        $result2 = $mysqli->query($query2);
                        $no     = $mulai+0;
                      ?>
                    <a href="form_tambah_admin.php" class="btn btn-info" style="margin-left: 980px;">Tambah Data</a><br><br>
                      <?php if ($total > 0) { ?>
                        ...
                        <tr>
                          <td><?php echo $no;?></td>
                          <td><img src="<?php echo "foto/". $foto;?>" width="100px"></td>
                          <td><?php echo $id;?></td>
                          <td><?php echo $nama;?></td>
                          <td><?php echo $username;?></td>
                          <td><?php echo $password;?></td>
                          <td>
                            <a href="form_edit_admin.php?id=<?php echo $id;?>" class="btn btn-warning">Edit</a><a href="delete_admin.php?id=<?php echo $id;?>" class="btn btn-danger">Delete</a>
                          </td>
                        </tr>
                        <?php } ?>
                    	</table>
