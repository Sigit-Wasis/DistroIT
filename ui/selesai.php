...
<body>
    ...
    <?php
			if($_POST['finish']){
				echo 'Terima kasih Anda sudah berbelanja di Toko Online kami dan berikut ini adalah data yang perlu Anda catat. <br><br>';
				echo '<p>Anda telah membeli barang '.$nama_brg.'.</p>';
				echo '<p>Total biaya untuk pembelian Produk adalah Rp. '.$harga_brg.',- dan biaya bisa di kirimkan melalui Rekening Bank Mandiri cabang Cikarang dengan nomor rekening 123-234-56347-8 atas nama Hakko Bio Richard.</p>';
                ...
                echo 'Total Belanja : Rp. '.$harga_brg.',-</p>';
			}else{
