...
<body>
    ...
    <form id="formku" action="selesai.php?id=<?php echo $id;?>" method="post">
    <table class="table table-condensed">
        <input name="id" type="hidden" class="required" value="<?php echo $id; ?>" />
   	  <tr>
      ...
      <tr>
      <td></td>
        <td><input type="submit" value="Simpan Data" name="finish"  class="btn btn-sm btn-primary"/>&nbsp;<a href="produk.php" class="btn btn-sm btn-primary">Kembali</a></td>
        </tr>
    </table>
    </form>
                   </div>
